...
% Do the same of the right hand side squares, but not concatenate these
% into a single matrix. This is because we will be drawing these both in a
...
% we achieve the same ordering of squares by placing the coordinates fo the
% square we want to draw first into the matrix first.
Screen('FillRect', window, rightRectColors, rightRects);

% Flip the screen. This command basically draws all of our previous
