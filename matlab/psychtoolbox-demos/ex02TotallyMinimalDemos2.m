%% [Totally Minimal Demo #2](http://peterscarfe.com/totallyminimaldemo2.html)
...
% "windowRect".
% "windowRect" is a vector numbers: the first is the X coordinate
...
% Query the inter-frame-interval. This refers to the minimun possible time
...
% We can also query the "nomial" refresh rate of our screen. This is
