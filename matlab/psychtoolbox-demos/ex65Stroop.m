...
% they respond with and the final row the time they took to make these response.
...
for trial = 1:numTrials
    ...
    % time stamp
    for frame = 1:isiTimeFrames - 1 % Namely, 1:59 on my Mac
    ...
    % our reaction time. We could do this directly with the vbl time
    % stamps, but for the purposes of this introductory demo we will use
    % GetSecs.
    % 
    ...
    while respToBeMade == true
        ...
        if keyCode(escapeKey)
            ShowCursor;
            sca;
            % https://ww2.mathworks.cn/help/matlab/ref/return.html
            return
